...
public class FileRun {
	public static void main(String[] args) {
		...
		File dir2 = new File("C:\\parentDir\\childDir"); //선언과 생성 c드라이브 -> pardir -> childDir
		dir2.mkdirs();
...
//		File path2 = new File("C:\\parentDir"); //childdir 먼저 지우고,parent지움
//		path2.delete();
		
		// 3. 디렉토리 존재 유무 확인
		File dir3 = new File("C:\\testDir");
//		if(!dir3.exists() ) { //없으면 만들어주세요
//			dir3.mkdirs();
//			if(dir3.mkdirs()) {
...
//		if(dir3.exists()) {  // => 있으면 없애고, 없으면 만든다
//			dir3.delete();
//		}else {
//			dir3.mkdirs();
//		}
